...
async def get_user_calendar(group: str, session: Session):
    user_calendar = Calendar()
    startday = datedatetime(
        datedatetime.today().year, datedatetime.today().month, datedatetime.today().day
    )
...
def get_end_of_semester_date():
    if datedatetime.today().month in range(2, 6):
        ...
        return datedatetime(
            datedatetime.today().year,
            datedatetime.today().month,
            datedatetime.today().day,
        )
